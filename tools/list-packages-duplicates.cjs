// Lists all packages with duplicate versions in a JSON input stream.
// Usage: pnpm list --depth 0 --json -r | node ./tools/list-packages-duplicates.cjs
// Usage: pnpm list --depth 9999 --json -r | node ./tools/list-packages-duplicates.cjs
