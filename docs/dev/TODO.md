...
Create a todo app with test scenarios.
Set up tests, see if chat can read the logs.
Filter props for specified objects.
useAutoTracer returning a logger.
Library Test Coverage
Refactor
Can useAutoTracer be autoinjected using AST?
