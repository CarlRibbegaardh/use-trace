...
vi.mock("@src/lib/features/autoTracer/functions/extractPropChanges.js", () => {
  return {
...
vi.mock(
  "@src/lib/features/autoTracer/functions/extractUseStateValues.js",
  () => {
    return {
...
vi.mock(
  "@src/lib/features/autoTracer/functions/getRealComponentName.js",
  () => {
    return {
...
vi.mock(
  "@src/lib/features/autoTracer/functions/componentLogRegistry.js",
  () => {
    return {
  ...
  describe("resetDepthTracking", () => {
    it("should reset depth tracking", async () => {
      const { resetDepthTracking } = await import(
        "@src/lib/features/autoTracer/functions/walkFiberForUpdates.js"
      );
  ...
  describe("walkFiberForUpdates", () => {
    ...
    it("should process component fiber with elementType", async () => {
      ...
      const { getComponentName } = vi.mocked(
        await import(
          "@src/lib/features/autoTracer/functions/getComponentName.js"
        )
      );
    ...
    it("should identify mount vs render vs reconciled", async () => {
      ...
      const { hasRenderWork } = vi.mocked(
        await import(
          "@src/lib/features/autoTracer/functions/reactFiberFlags.js"
        )
      );
    ...
    it("should handle prop changes extraction", async () => {
      ...
      const { extractPropChanges } = vi.mocked(
        await import(
          "@src/lib/features/autoTracer/functions/extractPropChanges.js"
        )
      );
      const { getTrackingGUID } = vi.mocked(
        await import("@src/lib/features/autoTracer/functions/renderRegistry.js")
