...
} from "@src/lib/features/autoTracer/functions/componentAnalysis.js";

// Mock dependencies
vi.mock("@src/lib/features/autoTracer/functions/getComponentName.js", () => {
  return {
    getComponentName: vi.fn(),
  };
});

vi.mock("@src/lib/features/autoTracer/functions/getRealComponentName.js", () => {
  return {
...
vi.mock("@src/lib/features/autoTracer/functions/reactFiberFlags.js", () => {
  return {
    Placement: 2,
    hasRenderWork: vi.fn(),
  };
...
describe("componentAnalysis", () => {
  ...
  describe("determineRenderType", () => {
    it("should return Mount for new mount with placement flags", async () => {
      const { Placement } = await import("@src/lib/features/autoTracer/functions/reactFiberFlags.js");
    ...
    it("should return Rendering when component has render work", async () => {
      const { hasRenderWork } = await import("@src/lib/features/autoTracer/functions/reactFiberFlags.js");
  ...
  describe("analyzeComponentFiber", () => {
    ...
    it("should analyze component fiber completely", async () => {
      const { getComponentName } = await import("@src/lib/features/autoTracer/functions/getComponentName.js");
      const { getRealComponentName } = await import("@src/lib/features/autoTracer/functions/getRealComponentName.js");
